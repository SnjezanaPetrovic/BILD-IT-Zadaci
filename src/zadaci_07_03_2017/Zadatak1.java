...
public class Zadatak1 {
	...
	// enter three
	// sides of the triangle, a color, and a Boolean value to indicate whether
	// the triangle
	...
	public static void main(String[] args) {
		...
		Triangle triangle1 = new Triangle(2, 5, 7);
		...
		System.out.println("The circle was created on " + triangle1.getDate());
