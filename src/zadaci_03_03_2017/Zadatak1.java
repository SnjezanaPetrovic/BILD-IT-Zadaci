...
public class Zadatak1 {
	...
	// ■ A constructor that constructs a Time object with a specified elapsed
	// time
	...
	// for the object using the elapsed time. For example, if the elapsed time
	// is
	...
	// format
	// hour:minute:second.
	// (Hint: The first two constructors will extract the hour, minute, and
	// second
	// from the elapsed time. For the no-arg constructor, the current time can
	// be
	// obtained using System.currentTimeMillis()

	public static void main(String[] args) {
		// pravimo objekte i pozivamo metode iz Time klase da bi ispisali
		// rezultat
		Time time1 = new Time();
